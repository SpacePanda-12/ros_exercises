...
while not rospy.is_shutdown():
    ...
    left_to_right_quaternion = tf.transformation.quaternion_from_matrix(np.array([left_to_right_transform[0][0], left_to_right_transform[0][1], left_to_right_transform[0][2], left_to_right_transform[1][0], left_to_right_transform[1][1], left_to_right_transform[1][2], left_to_right_transform[2][0], left_to_right_transform[2][1], left_to_right_transform[2][2]]))
